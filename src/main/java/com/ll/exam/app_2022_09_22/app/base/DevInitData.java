...
public class DevInitData {
    ...
    public CommandLineRunner initData(CashService cashService, MemberService memberService, ProductService productService, CartService cartService, OrderService orderService) {
        return args ->
        {
            ...
            // 삼십만원 충전
            memberService.addCash(member1, 300_000, "출금__무통장입금");
            ...
            cartService.addItem(member2, product1Option__RED_44, 1); // product1Option__RED_44 총 수량 1
            cartService.addItem(member2, product2Option__BLACK_44, 2); // product2Option__BLACK_44 총 수량 2
            cartService.addItem(member2, product2Option__WHITE_44, 2); // product2Option__WHITE_44 총 수량 2
